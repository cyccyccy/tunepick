...
function curl(urlString, opts = {}) {
  ...
  return new Promise((resolve, reject) => {
    execFile('curl', args, { maxBuffer: 32 * 1024 * 1024, encoding: 'utf8' }, (err, stdout, stderr) => {
      if (err) {
...
module.exports = { httpGetJson, webGet, webPost, curl, sleep, RateLimiter, detectBusinessError, classify, splitCurlOutput };
